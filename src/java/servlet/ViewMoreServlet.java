    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (productDTO pro : products) {
                String img = pro.getImg().getImg();
                request.setAttribute("LIST_IMAGE" + ctt, img);
                ctt++;
            }
            ...
            request.getRequestDispatcher("DispatchServlet?btAction=ViewMorePage").forward(request, response);
            out.close();
        }
    }
